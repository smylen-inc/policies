...
HIPAA compliance is complicated, but it doesn't have to be. Smylen helps relieve the technical burden with our HIPAA-compliant cloud computing platform and solutions for healthcare.
...
2. When ready, download the policies and comb through for mentions of Smylen or our business and change to appropriate references to your company.
...
[Smylen](htts://smylen.com), healthcare's trusted HITRUST CSF Certified digital health platform.

We help companies who handle PHI, both business associates and covered entities, maintain compliance with our ([Compliant Cloud](https://smylen.com/compliant-cloud)) and ([Managed Integration](https://smylen.com)).
